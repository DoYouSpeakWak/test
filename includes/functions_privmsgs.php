...
function submit_pm($mode, $subject, &$data, $put_in_outbox = true)
{
	...
	if ($mode != 'edit')
	{
		// start mod direct pm links in notification emails (and end mod too)...added $data['msg_id'] to the next line
...
* PM Notification
*/
// start mod direct pm links in notification emails (and end mod too)...added $msg_id to the next line
function pm_notification($mode, $author, $recipients, $subject, $message, $msg_id)
{
	...
	foreach ($msg_list_ary as $pos => $addr)
	{
		...
		$messenger->assign_vars(array(
			...
			// start mod direct pm links in notification emails (and end mod too)...changed next line to point to the pm itself rather than the inbox
