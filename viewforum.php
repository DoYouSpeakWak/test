...
if (sizeof($topic_list))
{
	...
	foreach ($topic_list as $topic_id)
	{
        ...
        {
        $s_type_switch_test = ($row['topic_type'] == POST_STICKY || $row['topic_type'] == POST_NORMAL) ? 1 : 0;
        }
		...
		$s_type_switch = ($row['topic_type'] == POST_STICKY || $row['topic_type'] == POST_NORMAL) ? 1 : $s_type_switch_test;
